...
сховища, лише дописується. `feature/<задача>` — гілка агента від головної; прийняття версії
сховища заміною піддерева (`adopt`) — `v8storagekit:reconcile`; PR — `v8storagekit:finish`.
Реплей у головну гілку не йде.
