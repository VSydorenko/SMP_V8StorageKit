---
name: finish
description: Закрити задачу агента — синхронізувати сховище, канонізувати дерево, прийняти дзеркало сховища в гілку задачі (adopt, заміною піддерева), звірити її зі сховищем, прогнати тести й синтаксис Unica, зібрати артефакти, підготувати PR у головну гілку. Тригери — «закриваємо задачу», «готуй PR», «фінішуємо», «здай роботу», «finish».
---
