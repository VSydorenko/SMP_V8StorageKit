...
- **Методика виконання — та сама, що в B4–B6** (розділ «Як виконувати цей план» у будь-якому
  ...
  текст задачі заморожений на час її виконання. Тут **усі** задачі — `механічна`: тексти поза репозиторієм kit,
  логіки немає. Рев'ю не потрібне взагалі — його заміняє показ diff користувачу перед кожним
  записом, який і так вимагає шапка плану.
