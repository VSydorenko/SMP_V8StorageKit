...
3. Round-trip за розділом вище: завантажити в базу, що вже тримає базову конфігурацію
   (машинна база воркспейсу `<Продукт>/build/ib`, наповнена `operation=build`; порожня
   тимчасова ІБ kit годиться лише розширенню без власних об'єктів, що посилаються на
   метадані базової конфігурації), вивантажити в порожню теку, звірити, замінити
